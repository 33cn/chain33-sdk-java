...
import cn.chain33.javasdk.model.abi.datatypes.primitive.PrimitiveType;
...
import static cn.chain33.javasdk.model.abi.datatypes.Type.MAX_BIT_LENGTH;
import static cn.chain33.javasdk.model.abi.datatypes.Type.MAX_BYTE_LENGTH;
...
public class TypeEncoder {
    ...
    public static String encode(Type parameter) {
        ...
        } else if (parameter instanceof AddressBTC) {
            return encodeAddressBTC((AddressBTC) parameter);
        } else if (parameter instanceof AddressETH) {
            return encodeAddressETH((AddressETH) parameter);
    ...
    static String encodeAddressBTC(AddressBTC address) {
        return encodeNumeric(address.toUint());
    }

    static String encodeAddressETH(AddressETH address) {
        return encodeNumeric(address.toUint());
    }
