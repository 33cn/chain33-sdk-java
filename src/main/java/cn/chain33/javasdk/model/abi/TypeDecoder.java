...
import cn.chain33.javasdk.model.abi.datatypes.primitive.Double;
import cn.chain33.javasdk.model.abi.datatypes.primitive.Float;
...
import static cn.chain33.javasdk.model.abi.DefaultFunctionReturnDecoder.getDataOffset;
import static cn.chain33.javasdk.model.abi.TypeReference.makeTypeReference;
import static cn.chain33.javasdk.model.abi.Utils.getSimpleTypeName;
...
public class TypeDecoder {
    ...
    static <T extends Type> T decode(String input, int offset, Class<T> type) {
        ...
        } else if (AddressBTC.class.isAssignableFrom(type)) {
            return (T) decodeAddressBTC(input.substring(offset));
        } else if (AddressETH.class.isAssignableFrom(type)) {
            return (T) decodeAddressETH(input.substring(offset));
    ...
    static AddressBTC decodeAddressBTC(String input) {
        return new AddressBTC(decodeNumeric(input, Uint160.class));
    }

    static AddressETH decodeAddressETH(String input) {
        return new AddressETH(decodeNumeric(input, Uint160.class));
    }
    ...
    static Type instantiateArrayType(TypeReference ref, Object value)
        ...
        if (arraySize <= 0) {
            ...
            Class<?> arrayClass =
                    Class.forName("cn.chain33.javasdk.model.abi.datatypes.generated.StaticArray" + arraySize);
        ...
        try {
            Class<? extends StaticArray> arrayClass =
                    (Class<? extends StaticArray>)
                            Class.forName("cn.chain33.javasdk.model.abi.datatypes.generated.StaticArray" + length);
