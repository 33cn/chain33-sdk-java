...
import cn.chain33.javasdk.model.abi.datatypes.primitive.Int;
...
import cn.chain33.javasdk.model.abi.datatypes.primitive.*;
    ...
    public static Class<? extends Type> getType(String type, boolean primitives) {
        switch (type) {
            ...
            case "uint":
                return Uint.class;
            case "int":
                return primitives ? Int.class : cn.chain33.javasdk.model.abi.datatypes.Int.class;
            case "long":
                return Long.class;
            case "short":
                return Short.class;
