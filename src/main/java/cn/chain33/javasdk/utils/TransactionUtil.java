...
public class TransactionUtil {
    ...
    public static byte[] createTransferPayLoad(String to, Long amount, String coinToken, String note) {
        TransactionAllProtobuf.AssetsTransfer.Builder assetsTransferBuilder = TransactionAllProtobuf.AssetsTransfer
                .newBuilder();
    ...
    public static TransactionAllProtobuf.Transaction createTransferTx2(String privateKey, String toAddress,
            String execer, byte[] payLoad, long fee, long txheight) {
        byte[] privateKeyBytes = HexUtil.fromHexString(privateKey);
     ...
     *
     */
    public static TransactionAllProtobuf.Transaction createTxMain2(byte[] privateKey, String toAddress, byte[] execer,
            byte[] payLoad, SignType signType, long fee, Long txHeight) {
        if (signType == null)
            signType = DEFAULT_SIGNTYPE;
    ...
    public static String createTxWithCert(String privateKey, String execer, byte[] payLoad, SignType signType,
            byte[] cert, byte[] uid) {
        if (signType == null)
            signType = DEFAULT_SIGNTYPE;
    ...
    public static TransactionAllProtobuf.Transaction createTxWithCertProto(String privateKey, String execer,
            byte[] payLoad, SignType signType, byte[] cert, byte[] uid) {
        if (signType == null)
            signType = DEFAULT_SIGNTYPE;
    ...
    public static String signRawTx(String privateKey, long expire, String txHex, Integer index) throws Exception {
        ...
        // 如果执行器为privacy 暂时不处理
        /*
         * if(Arrays.equals(ExecerPrivacy,rawtransactionProtobuf.getExecer(). toByteArray ())) { //signTxWithPrivacy }
         */
    ...
    public static String signDecodeTx(List<DecodeRawTransaction> decodeRawTransactions, String execerAddress,
        ...
        TransactionAllProtobuf.Transaction unNoneTx = TransactionUtil.decodeTxToProtobuf(signedSeconedTx,
                execerAddress);
        ...
        TransactionAllProtobuf.Transaction.Builder thirdBuilder = TransactionAllProtobuf.Transaction
                .newBuilder(noneTxNew);
    ...
    public static String createManage(String key, String value, String op, String privateKey, String execer) {
        ...
        cn.chain33.javasdk.model.protobuf.ManageProtobuf.ManageAction.Builder actionBuilder = ManageProtobuf.ManageAction
                .newBuilder();
     ...
     *
     */
    public static String createTokenTransferTx(String privateKey, String toAddress, String execer, Long amount,
            String coinToken, String note) {
    ...
    public static byte[] createtTokenTransferPayLoad(String to, Long amount, String coinToken, String note) {
        TokenActionProtoBuf.AssetsTransfer.Builder assetsTransferBuilder = TokenActionProtoBuf.AssetsTransfer
                .newBuilder();
        assetsTransferBuilder.setCointoken(coinToken);
        assetsTransferBuilder.setAmount(amount);
        try {
        ...
        assetsTransferBuilder.setTo(to);
        cn.chain33.javasdk.model.protobuf.TokenActionProtoBuf.AssetsTransfer assetsTransfer = assetsTransferBuilder
                .build();
        TokenActionProtoBuf.TokenAction.Builder tokenActionBuilder = TokenActionProtoBuf.TokenAction.newBuilder();
