...
public class StorageUtil {
    ...
    public static String createOnlyNotaryStorage(byte[] content, String execer, String privateKey) {
        ...
        cn.chain33.javasdk.model.protobuf.StorageProtobuf.StorageAction.Builder storageActionBuilder = StorageProtobuf.StorageAction
                .newBuilder();
     ...
     *
     */
    public static String createOnlyNotaryStorage(String key, String value, Integer op, String execer,
            String privateKey) {
        Builder contentOnlyNotaryStorageBuilder = StorageProtobuf.ContentOnlyNotaryStorage.newBuilder();
    ...
    public static String createHashStorage(byte[] hash, String execer, String privateKey) {
        cn.chain33.javasdk.model.protobuf.StorageProtobuf.HashOnlyNotaryStorage.Builder hashStorageBuilder = StorageProtobuf.HashOnlyNotaryStorage
                .newBuilder();
    ...
    public static String createLinkNotaryStorage(byte[] link, byte[] hash, String execer, String privateKey) {
        cn.chain33.javasdk.model.protobuf.StorageProtobuf.LinkNotaryStorage.Builder storageBuilder = StorageProtobuf.LinkNotaryStorage
                .newBuilder();
    ...
    public static String createEncryptNotaryStorage(byte[] encryptContent, byte[] contentHash, byte[] nonce, String key,
        ...
        cn.chain33.javasdk.model.protobuf.StorageProtobuf.EncryptNotaryStorage.Builder storageBuilder = StorageProtobuf.EncryptNotaryStorage
                .newBuilder();
     ...
     * 
     * @param contentHash
     *            存证明文内容的hash值，推荐使用sha256哈希，限制256位的摘要值
     * @param content
     *            源文件的密文。
     * @param nonce
     *            加密iv，通过AES进行加密时制定随机生成的iv,解密时需要使用该值
     ...
     * @param keyWrap
     *            加密key的wrap key。加密key随机生成，对明文进行加密，该key有私密key进行key wrap后公开。使用时，通过私密key对wrap key解密得到加密key对密文进行解密。
     * 
     * @return payload
     *
     */
    public static String createEncryptShareNotaryStorage(byte[] contentHash, byte[] content, byte[] nonce,
            byte[] keyName, byte[] keyWrap, String execer, String privateKey) {
        cn.chain33.javasdk.model.protobuf.StorageProtobuf.EncryptShareNotaryStorage.Builder storageBuilder = StorageProtobuf.EncryptShareNotaryStorage
                .newBuilder();
        storageBuilder.setContentHash(ByteString.copyFrom(contentHash));
    ...
    public static String createEncryptNotaryAdd(byte[] encryptContent, String key, String privateKey) {
        ...
        // StorageAction storageAction = storageActionBuilder.build();
        //
        // String createTxWithoutSign = TransactionUtil.createTxWithoutSign("storage".getBytes(),
        // storageAction.toByteArray(),
        // TransactionUtil.DEFAULT_FEE, 0);
        // byte[] fromHexString = HexUtil.fromHexString(createTxWithoutSign);
        // TransactionAllProtobuf.Transaction parseFrom = null;
     ...
     *
     */
    public static TransactionAllProtobuf.Transaction createOnlyNotaryStorageGrpc(byte[] content, String execer,
            String privateKey) {
        Builder contentOnlyNotaryStorageBuilder = StorageProtobuf.ContentOnlyNotaryStorage.newBuilder();
        contentOnlyNotaryStorageBuilder.setContent(ByteString.copyFrom(content));// 内容小于512k;
        cn.chain33.javasdk.model.protobuf.StorageProtobuf.StorageAction.Builder storageActionBuilder = StorageProtobuf.StorageAction
     ...
     * @return
     */
    public static String createOnlyNotaryStorageGrpc(byte[] content, String execer, String privateKey,
            String contranctAddress) {
        Builder contentOnlyNotaryStorageBuilder = StorageProtobuf.ContentOnlyNotaryStorage.newBuilder();
        contentOnlyNotaryStorageBuilder.setContent(ByteString.copyFrom(content));// 内容小于512k;
        cn.chain33.javasdk.model.protobuf.StorageProtobuf.StorageAction.Builder storageActionBuilder = StorageProtobuf.StorageAction
     ...
     *
     */
    public static TransactionAllProtobuf.Transaction createHashStorageGrpc(byte[] hash, String execer,
            String privateKey) {
        cn.chain33.javasdk.model.protobuf.StorageProtobuf.HashOnlyNotaryStorage.Builder hashStorageBuilder = StorageProtobuf.HashOnlyNotaryStorage
                .newBuilder();
        hashStorageBuilder.setHash(ByteString.copyFrom(hash));
     ...
     *
     */
    public static TransactionAllProtobuf.Transaction createLinkNotaryStorageGrpc(byte[] link, byte[] hash,
            String execer, String privateKey) {
        cn.chain33.javasdk.model.protobuf.StorageProtobuf.LinkNotaryStorage.Builder storageBuilder = StorageProtobuf.LinkNotaryStorage
                .newBuilder();
        storageBuilder.setLink(ByteString.copyFrom(link));
        storageBuilder.setHash(ByteString.copyFrom(hash));
     ...
     *
     */
    public static String createLinkNotaryStorageGrpc(byte[] link, byte[] hash, String execer, String privateKey,
            String contranctAddress) {
        cn.chain33.javasdk.model.protobuf.StorageProtobuf.LinkNotaryStorage.Builder storageBuilder = StorageProtobuf.LinkNotaryStorage
                .newBuilder();
        storageBuilder.setLink(ByteString.copyFrom(link));
     ...
     *
     */
    public static TransactionAllProtobuf.Transaction createEncryptNotaryStorageGrpc(byte[] encryptContent,
            byte[] contentHash, byte[] nonce, String key, String value, String execer, String privateKey) {
        cn.chain33.javasdk.model.protobuf.StorageProtobuf.EncryptNotaryStorage.Builder storageBuilder = StorageProtobuf.EncryptNotaryStorage
                .newBuilder();
        storageBuilder.setEncryptContent(ByteString.copyFrom(encryptContent));
        storageBuilder.setContentHash(ByteString.copyFrom(contentHash));
     ...
     *
     */
    public static String createEncryptNotaryStorageGrpc(byte[] encryptContent, byte[] contentHash, byte[] nonce,
            String key, String value, String execer, String privateKey, String contranctAddress) {
        cn.chain33.javasdk.model.protobuf.StorageProtobuf.EncryptNotaryStorage.Builder storageBuilder = StorageProtobuf.EncryptNotaryStorage
                .newBuilder();
        storageBuilder.setEncryptContent(ByteString.copyFrom(encryptContent));
        storageBuilder.setContentHash(ByteString.copyFrom(contentHash));
     ...
     *
     */
    public static String createEncryptShareNotaryStorageGrpc(byte[] contentHash, byte[] content, byte[] nonce,
            byte[] keyName, byte[] keyWrap, String execer, String privateKey) {
        cn.chain33.javasdk.model.protobuf.StorageProtobuf.EncryptShareNotaryStorage.Builder storageBuilder = StorageProtobuf.EncryptShareNotaryStorage
                .newBuilder();
        storageBuilder.setContentHash(ByteString.copyFrom(contentHash));
