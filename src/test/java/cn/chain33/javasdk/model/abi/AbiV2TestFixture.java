...
public class AbiV2TestFixture {
    ...
    public static class Foo extends DynamicStruct {
        ...
        public Foo(String id, String name) {
            super(
                    new cn.chain33.javasdk.model.abi.datatypes.Utf8String(id),
                    new cn.chain33.javasdk.model.abi.datatypes.Utf8String(name));
            this.id = id;
            this.name = name;
        }
    ...
    public static final cn.chain33.javasdk.model.abi.datatypes.Function setFooFunction =
    ...
    @SuppressWarnings("unchecked")
    public static final cn.chain33.javasdk.model.abi.datatypes.Function setBarDynamicArrayFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
    ...
    public static final cn.chain33.javasdk.model.abi.datatypes.Function getNarDynamicArrayFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
    ...
    public static class Bar extends StaticStruct {
        ...
        public Bar(BigInteger id, BigInteger data) {
            super(
                    new cn.chain33.javasdk.model.abi.datatypes.generated.Uint256(id),
                    new cn.chain33.javasdk.model.abi.datatypes.generated.Uint256(data));
            this.id = id;
            this.data = data;
        }
    ...
    public static final cn.chain33.javasdk.model.abi.datatypes.Function setBarFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
                    FUNC_SETBAR,
                    Arrays.<Type>asList(new Bar(BigInteger.ONE, BigInteger.TEN)),
                    Collections.<TypeReference<?>>emptyList());

    public static final cn.chain33.javasdk.model.abi.datatypes.Function getBarFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
                    FUNC_GETBAR,
                    Arrays.<Type>asList(),
    ...
    public static final cn.chain33.javasdk.model.abi.datatypes.Function setBazFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
                    FUNC_SETBAZ,
    ...
    public static final cn.chain33.javasdk.model.abi.datatypes.Function setBozFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
                    FUNC_SETBOZ,
                    Arrays.<Type>asList(new Boz(BigInteger.ONE, "id")),
                    Collections.<TypeReference<?>>emptyList());

    public static final cn.chain33.javasdk.model.abi.datatypes.Function getBozFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
                    FUNC_SETBOZ,
    ...
    public static class Fuzz extends StaticStruct {
        ...
        public Fuzz(Bar bar, BigInteger data) {
            super(bar, new cn.chain33.javasdk.model.abi.datatypes.generated.Uint256(data));
            this.bar = bar;
            this.data = data;
        }
    ...
    public static final cn.chain33.javasdk.model.abi.datatypes.Function setFooDynamicArrayFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
    ...
    public static final cn.chain33.javasdk.model.abi.datatypes.Function setDoubleFooStaticArrayFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
                    FUNC_SETFOODYNAMICARRAY,
                    Arrays.<Type>asList(new Foo("", ""), new Foo("id", "name"), new Foo("", "")),
                    Collections.emptyList());

    public static final cn.chain33.javasdk.model.abi.datatypes.Function setFuzzFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
                    FUNC_SETFUZZ,
                    Arrays.<Type>asList(
    ...
    public static final cn.chain33.javasdk.model.abi.datatypes.Function getFuzzFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
                    FUNC_GETFUZZ,
                    Arrays.<Type>asList(),
    ...
    public static final cn.chain33.javasdk.model.abi.datatypes.Function setNuuFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
                    FUNC_SETNUU,
                    Arrays.<Type>asList(new Nuu(new Foo("id", "name"))),
                    Collections.<TypeReference<?>>emptyList());

    public static final cn.chain33.javasdk.model.abi.datatypes.Function getNuuFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
                    FUNC_SETNUU,
                    Collections.<Type>emptyList(),
    ...
    public static class Naz extends DynamicStruct {
        ...
        public Naz(Nar nar, BigInteger data) {
            super(nar, new cn.chain33.javasdk.model.abi.datatypes.generated.Uint256(data));
            this.nar = nar;
            this.data = data;
        }
    ...
    public static class Nazz extends DynamicStruct {
        ...
        public Nazz(Naz naz, BigInteger data) {
            super(naz, new cn.chain33.javasdk.model.abi.datatypes.generated.Uint256(data));
            this.naz = naz;
            this.data = data;
        }
    ...
    public static final cn.chain33.javasdk.model.abi.datatypes.Function setNazFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
                    FUNC_SETNAZ,
                    Arrays.<Type>asList(
    ...
    public static class Wiz extends DynamicStruct {
        ...
        public Wiz(Foo foo, String data) {
            super(foo, new cn.chain33.javasdk.model.abi.datatypes.Utf8String(data));
            this.foo = foo;
            this.data = data;
        }
    ...
    public static final cn.chain33.javasdk.model.abi.datatypes.Function setWizFunction =
            new cn.chain33.javasdk.model.abi.datatypes.Function(
                    FUNC_SETWIZ,
    ...
    public static class BytesStruct extends DynamicStruct {
        ...
        public BytesStruct(byte[] pubkey, BigInteger something, byte[] metadata) {
            super(
                    new cn.chain33.javasdk.model.abi.datatypes.DynamicBytes(pubkey),
                    new cn.chain33.javasdk.model.abi.datatypes.generated.Uint32(something),
                    new cn.chain33.javasdk.model.abi.datatypes.DynamicBytes(metadata));
            this.pubkey = pubkey;
