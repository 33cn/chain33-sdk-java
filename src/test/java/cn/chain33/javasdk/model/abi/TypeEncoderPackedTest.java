...
import cn.chain33.javasdk.model.abi.datatypes.generated.StaticArray0;
...
class TypeEncoderPackedTest {
    ...
    public void testPrimitiveIntEncodePacked() {
        assertEquals(
                "00000000", TypeEncoder.encodePacked(new cn.chain33.javasdk.model.abi.datatypes.primitive.Int(0)));

        assertEquals(
                "80000000",
                TypeEncoder.encodePacked(
                        new cn.chain33.javasdk.model.abi.datatypes.primitive.Int(Integer.MIN_VALUE)));

        assertEquals(
                "7fffffff",
                TypeEncoder.encodePacked(
                        new cn.chain33.javasdk.model.abi.datatypes.primitive.Int(Integer.MAX_VALUE)));
    }
    ...
    public void testPrimitiveFloatEncodePacked() {
        assertThrows(
                UnsupportedOperationException.class,
                () -> TypeEncoder.encodePacked(new cn.chain33.javasdk.model.abi.datatypes.primitive.Float(0)));
    }
    ...
    public void testPrimitiveDouble() {
        assertThrows(
                UnsupportedOperationException.class,
                () -> TypeEncoder.encodePacked(new cn.chain33.javasdk.model.abi.datatypes.primitive.Double(0)));
    }
}
